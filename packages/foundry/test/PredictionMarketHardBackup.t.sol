...
import { PredictionMarketHardBackUp } from "../contracts/PredictionMarketHardBackUp.sol";
import { PredictionOptionToken } from "../contracts/PredictionOptionToken.sol";

contract PredictionMarketHardTest is Test {
    PredictionMarketHardBackUp public predictionMarket;
    ...
    function setUp() public {
        predictionMarket = new PredictionMarketHardBackUp(oracle);
    ...
    modifier withPrediction() {
        ...
        predictionMarket.createPrediction{ value: 10 ether }(
            "Will ETH reach $10k?", options, block.timestamp + 100, 10 ether, 1000 ether
        );
        _;
    }
